...
const columns: TableProps<HqStockResponse>["columns"] = [
  {
    title: "번호",
    dataIndex: "id",
    key: "id",
  },
  {
    ...
    render: (_, record) => (
      <Link
        to={PATHS.HQ.PRODUCTS.DETAIL(record.productId)}
...
export default function InventoryPage() {
  ...
  const { data: stocks, isLoading } = useHqStocks({
